...
def read_TrueClient_MedImpact(f):
...
def map_TrueClient_BCBSAL(batch, output_header, employer_code): 
...
def map_TrueClient_MedImpact(batch, output_header, employer_code): 
...
def map_TrueClient_Metlife(batch, output_header, employer_code): 
...
def map_TrueClient_VSP(batch, output_header, employer_code): 
...
read = {
    ...
    'BCBSAL': read_TrueClient_BCBSAL,
    'MedImpact': read_TrueClient_MedImpact, 
    'Metlife': read_TrueClient_Metlife, 
    'VSP': read_TrueClient_VSP, 
}

map = {
    'RealMedCarrier': map_TrueClient_RealMedCarrier,
    'BCBSAL': map_TrueClient_BCBSAL,
    'MedImpact': map_TrueClient_MedImpact, 
    'Metlife': map_TrueClient_Metlife, 
    'VSP': map_TrueClient_VSP, 
}
